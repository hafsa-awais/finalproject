    ...
    <div class="description-contenner">
        ...
        <div class="icons-des">
            <div class="dancing-des">
                <lottie-player class="icon-des" src="https://assets10.lottiefiles.com/packages/lf20_qrvqpgft.json"
                    background="transparent" speed="0.5" autoplay></lottie-player>
            </div>
            <div class="church-des">
                <lottie-player class="icon-des" src="https://assets2.lottiefiles.com/packages/lf20_1gtlkp5r.json"
                    background="transparent" speed="0.5" autoplay></lottie-player>
            </div>
            <div class="scenery-des">
                <lottie-player class="icon-des" src="https://assets2.lottiefiles.com/packages/lf20_h9qzdfz8.json"
                    background="transparent" speed="0.5" autoplay></lottie-player>
            </div>
            <div class="fireworks-dis">
                <lottie-player class="icon-des" src="https://assets4.lottiefiles.com/packages/lf20_idbtqrtg.json"
                    background="transparent" speed="0.5" autoplay></lottie-player>
            </div>
            <div class="karaoke-des">
                <lottie-player class="icon-des" src="https://assets9.lottiefiles.com/packages/lf20_7rvfhjdu.json"
                    background="transparent" speed="0.5" autoplay></lottie-player>
            </div>
            <div class="catering-des">
                <lottie-player class="icon-des" src="https://assets3.lottiefiles.com/packages/lf20_7tduzoyu.json"
                    background="transparent" speed="0.5" autoplay></lottie-player>
            </div>
        ...
        <div class="---------main-des">
            ...
            <div class="main-des-main"> Our spacious and luxurious water villa will provide you an amazing holiday at the
                water. We’ve recently constructed this brand new family house with all convenient features you are looking
                for during your holiday. It’s a stand-alone house with all facilities provided we thought you would love.
                Everything is well thought of with the most convenient features. Grab the canoes and go out to explore the
                Loosdrechtse lakes. As a father of two teenagers I exactly know how to make my family happy!</div>
        </div>
        <div class="map-des">
            <!-- <p>
                                                ...
                                                <div class="d-flex row">
                                                    <div class="flex-shrink-0">
                                                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(1).webp"
                                                            ...
                                                            alt="woman avatar" width="60" height="60">
                                                    </div>
                                                        ...
                                                        <figure>
                                                            <blockquote class="blockquote mb-4">
                                                                <p>
                                                                    ...
                                                                    <span class="font-italic fs-6">Lorem ipsum dolor sit
                                                        ...
                                                        <figure>
                                                            <blockquote class="blockquote mb-4">
                                                                <p>
                                                                    <i
                                                                        class="fas fa-quote-left fa-lg text-warning me-2"></i>
                                                                    <span class="font-italic fs-6">Sed ut perspiciatis unde
                                                        ...
                                                        <figure>
                                                            <blockquote class="blockquote mb-4">
                                                                <p>
                                                                    <i
                                                                        class="fas fa-quote-left fa-lg text-warning me-2"></i>
                                                                    <span class="font-italic fs-6">At vero eos et accusamus
